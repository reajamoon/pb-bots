...
## User Experience
 - [ ] Unify `/rec update <id>` to use a single identifier field (ID, URL, AO3 ID, etc.) with internal logic to detect and handle all types. Simplifies the command and improves user experience.
