...
Recommendation.belongsTo(Series, { foreignKey: 'seriesId', targetKey: 'ao3SeriesId', as: 'series', constraints: false });
Series.hasMany(Recommendation, { foreignKey: 'seriesId', sourceKey: 'ao3SeriesId', as: 'works' });
...
UserFicMetadata.belongsTo(Series, { foreignKey: 'seriesId', targetKey: 'ao3SeriesId', as: 'series', constraints: false });
...
export { fetchSeriesWithUserMetadata } from './fetchSeriesWithUserMetadata.js';
